!=============================================================================!
        subroutine lrhs(vl, rl, vml, xl, yl)
!  
!  Computes the RHS for the linearized compressible Navier-Stokes with 
!  implicit time advancement 
!
!  Revised: 9-9-97
!           12-15-00   Changed indices for cache computers
!=============================================================================!
        use global
        use local2d
        implicit none
