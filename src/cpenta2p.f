!=============================================================================!
        subroutine cpenta2p( np, nsys, nblk, mat, rhs, per, per2, code )
!=============================================================================!
!  
...
!=============================================================================!
        ...
        complex mat(5,nblk,nblk,np,nsys), rhs(nblk,np,nsys)
        complex per(2,nblk,nblk,np,nsys), per2(np-2:np-1,nblk,nblk,np,nsys)
        complex mult, fact
