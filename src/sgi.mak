...
NAME     = lns3d 
#DEBUG    = -O2 
DEBUG    = -O2 -r10000 -TARG:platform=ip30 -mp -MP:old_mp=OFF
FFLAGS   = -r8 -cpp -col120 -c $(DEBUG)
F90FLAGS = -r8 -cpp -c $(DEBUG)
...
local3d.o  pot.o      bump.o	local2.o
#
...
expdrv.o       lhsbt2f.o      bcfix.o        calcp.o \
...
rhs.o      mlocal.o    rk.o       lrhs.o      \
impdrv.o   rkbc.o      imprk.o    rhs_l.o     \
gend_l.o   gend_n.o    gena_l.o   gena_n.o    \
...
nrk.o expdrv.o: global.o local2.o
