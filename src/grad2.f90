...
!.... interior
        ...
        if (yper) then
          ...
          if (bsym) then
            ...
            do i = 1, nx
              do idof = 1, ndof
                ...
                g22v(idof,i,1) = (isign * dy1 * v(idof,i,4)     + &
                                  isign * dy2 * v(idof,i,3)     + &
                                  isign * dy3 * v(idof,i,2)     + &
                                  dy4 * v(idof,i,1)             + &
                                  dy5 * v(idof,i,2)             + &
                                  dy6 * v(idof,i,3)             + &
                                  dy7 * v(idof,i,4)             ) 
    
                g22v(idof,i,2) = (isign * dy1 * v(idof,i,3)     + &
                                  isign * dy2 * v(idof,i,2)     + &
                                  dy3 * v(idof,i,1)             + &
                                  dy4 * v(idof,i,2)             + &
                                  dy5 * v(idof,i,3)             + &
                                  dy6 * v(idof,i,4)             + &
                ...
                g22v(idof,i,3) = (isign * dy1 * v(idof,i,2)     + &
                                  dy2 * v(idof,i,1)             + &
                                  dy3 * v(idof,i,2)             + &
                                  dy4 * v(idof,i,3)             + &
                                  dy5 * v(idof,i,4)             + &
          ...
          if (tsym) then
            ...
            call error('grad2$','Bsym not implemented$')
...
!.... boundaries
        ...
        if (yper) then
          ...
          if (bsym) then
            ...
            do i = 1, nx
              do idof = 1, ndof
                ...
                g12v(idof,i,1) = ( isign * gy1 * g1v(idof,i,4)  + &
                                  isign * gy2 * g1v(idof,i,3)   + &
                                  isign * gy3 * g1v(idof,i,2)   + &
                                  gy4 * g1v(idof,i,2)           + &
                                  gy5 * g1v(idof,i,3)           + &
                                  gy6 * g1v(idof,i,4)           ) 
    
                g12v(idof,i,2) = ( isign * gy1 * g1v(idof,i,3)  + &
                                  isign * gy2 * g1v(idof,i,2)   + &
                                  gy3 * g1v(idof,i,1)           + &
                                  gy4 * g1v(idof,i,3)           + &
                                  gy5 * g1v(idof,i,4)           + &
                                  gy6 * g1v(idof,i,5)           ) 
    
                g12v(idof,i,3) = ( isign * gy1 * g1v(idof,i,2)  + &
                                  gy2 * g1v(idof,i,1)           + &
                                  gy3 * g1v(idof,i,2)           + &
                                  gy4 * g1v(idof,i,4)           + &
                                  gy5 * g1v(idof,i,5)           + &
          ...
          if (tsym) then
            ...
            call error('grad$','Tsym not implemented$')
