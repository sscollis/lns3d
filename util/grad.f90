...
!.... Right boundary
        ...
        else                  ! normal boundary differences
          ...
          if (bsym) then
            ...
            do i = 1, nx
              do idof = 1, ndof
                ...
                g2v(idof,i,1) = ( isign * gy1 * v(idof,i,4)     + &
                                  isign * gy2 * v(idof,i,3)     + &
                                  isign * gy3 * v(idof,i,2)     + &
                                  gy4 * v(idof,i,2)             + &
                                  gy5 * v(idof,i,3)             + &
                                  gy6 * v(idof,i,4)             ) 
    
                g2v(idof,i,2) = ( isign * gy1 * v(idof,i,3)     + &
                                  isign * gy2 * v(idof,i,2)     + &
                                  gy3 * v(idof,i,1)             + &
                                  gy4 * v(idof,i,3)             + &
                                  gy5 * v(idof,i,4)             + &
                                  gy6 * v(idof,i,5)             ) 
    
                g2v(idof,i,3) = ( isign * gy1 * v(idof,i,2)     + &
                                  gy2 * v(idof,i,1)             + &
                                  gy3 * v(idof,i,2)             + &
                                  gy4 * v(idof,i,4)             + &
                                  gy5 * v(idof,i,5)             + &
