...
!.... variables for the Oseen Vortex
        ...
        real :: x0_1, x0_2, y0_1, y0_2, amp_1, amp_2, amp
...
!=============================================================================!
        ...
        read (*,*) Re, Ma, Pr
        write(*,"('Enter amp, x0, y0 for first vortex ==> ',$)")
        read (*,*) amp_1, x0_1, y0_1
        write(*,"('Enter amp, x0, y0 for second vortex ==> ',$)")
        read (*,*) amp_2, x0_2, y0_2
