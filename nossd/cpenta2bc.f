!=============================================================================!
        subroutine cpenta2bc( n, nsys, nblk, mat, rhs, mult, fact, code )
!=============================================================================!
!  
...
!=============================================================================!
        ...
        complex mat(n,nsys,nblk,nblk,5), rhs(n,nsys,nblk)
...
!.... for all columns
          ...
          do nc = 1, nblk
            ...
            do m = 1, nblk
              ...
              do iv = 1, nsys
                mult(iv) = mat(s,iv,m,nc,5)
                rhs(s,iv,m) = rhs(s,iv,m) + mult(iv) * rhs(i,iv,nc)
              end do

              do iv = 1, nsys
                mult(iv) = mat(t,iv,m,nc,4)
