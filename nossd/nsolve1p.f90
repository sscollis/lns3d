!=============================================================================!
	subroutine solve1p( nsys, np, nblk, mat, rhs, per, per2, mult, fact)
!=============================================================================!
!  
...
!=============================================================================!
	...
	real, intent(inout) :: mat(nsys,np,nblk,nblk*3), rhs(nsys,np,nblk)
	real, intent(inout) :: per(nsys,np,nblk,nblk), per2(nsys,nblk,2*nblk)
