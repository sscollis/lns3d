...
rhs_l.o    nrk.o       gend_l.o    gend_n.o    \
...
$(OBJS1): stuff.o
	$(COMP) $(F90FLAGS) -p stuff.o $*.f90

$(OBJS2): diff.o
	$(COMP) $(F90FLAGS) -p diff.o $*.f90

$(OBJS3): stuff.o local.o
	$(COMP) $(F90FLAGS) -p stuff.o -p local.o $*.f90

$(OBJS4): stuff.o diff.o pot.o
	$(COMP) $(F90FLAGS) -p stuff.o -p diff.o -p pot.o $*.f90

$(OBJS5): stuff.o diff.o buff_stuff.o pot.o
	$(COMP) $(F90FLAGS) -p stuff.o -p diff.o -p buff_stuff.o -p pot.o $*.f90

$(OBJS6): stuff.o local.o local3d.o
	$(COMP) $(F90FLAGS) -p stuff.o -p local.o -p local3d.o $*.f90

sponge.o: stuff.o spg_mod.o
	$(COMP) $(F90FLAGS) -p stuff.o -p spg_mod.o $*.f90

input.o: stuff.o spg_mod.o buff_stuff.o
	$(COMP) $(F90FLAGS) -p stuff.o -p spg_mod.o -p buff_stuff.o $*.f90

genmtrx.o: stuff.o local.o pot.o
	$(COMP) $(F90FLAGS) -p stuff.o -p local.o -p pot.o $*.f90

genbump.o: stuff.o bump.o
	$(COMP) $(F90FLAGS) -p stuff.o -p bump.o $*.f90

itrbc3d.o  rhsbc3d.o: stuff.o diff.o pot.o bump.o
	$(COMP) $(F90FLAGS) -p stuff.o -p diff.o -p pot.o -p bump.o $*.f90
